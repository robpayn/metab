# this script is used to complete a Monte Carlo Sensitivity Analysis of a pCO2 river metab model
...
# Set known standard error for pCO2
...
# write(x = c("dailyGPP", "dailyER", "k600"), file = "monteCarloEnsembleNlmrpCO2GPPof2.csv",
#       ncolumns = 3, sep = ",", append = TRUE)

# create loop to iteratively run nlm on synthetic data
...
# fill columns of previously created csv file with parameter estimations
  write(x = nlmr$estimate, file = "monteCarloEnsembleNlmrpCO2GPPof2.csv",
        ncolumns = 3, append = TRUE, sep = ",")
  
  }

# plot example of one iterations of pCO2 monte carlo
